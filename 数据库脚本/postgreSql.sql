...
CREATE TABLE "public"."flowinstance" (
  ...
  "businessid" varchar(255) COLLATE "pg_catalog"."default"
)
;
...
CREATE TABLE "public"."flowscheme" (
  ...
  "orgid" varchar(50) COLLATE "pg_catalog"."default",
  "frmurltemplate" varchar(50) COLLATE "pg_catalog"."default"
)
;
...
COMMENT ON COLUMN "public"."flowscheme"."frmurltemplate" IS 'URL表单模板';
