...
ALTER TABLE "RELEVANCE" ADD CONSTRAINT "SYS_C0032286" CHECK ("KEY" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
...
ALTER TABLE "STOCK" ADD CONSTRAINT "SYS_C0032299" CHECK ("STATUS" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "STOCK" ADD CONSTRAINT "SYS_C0032300" CHECK ("VIEWABLE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "STOCK" ADD CONSTRAINT "SYS_C0032301" CHECK ("CREATEUSER" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "STOCK" ADD CONSTRAINT "SYS_C0032302" CHECK ("TIME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
