...
CREATE TABLE "BUILDERTABLE" (
  ...
  "EXTERNALDATASOURCEID" NVARCHAR2(50)
)
LOGGING
NOCOMPRESS
PCTFREE 10
...
COMMENT ON COLUMN "BUILDERTABLE"."EXTERNALDATASOURCEID" IS '外部数据源ID';
COMMENT ON TABLE "BUILDERTABLE" IS '代码生成器的表信息';

-- ----------------------------
-- Records of BUILDERTABLE
-- ----------------------------
INSERT INTO "BUILDERTABLE" VALUES ('7f0ca2fd-7fa0-4316-a466-22733d466dd2', 'wmsinboundordertbl', '入库订单头表', NULL, NULL, 'wmsinboundordertbl', 'OpenAuth.Repository.Domain', 'WmsInApp', '入库模块', 'D:/OpenAuth.Pro/Client', NULL, NULL, NULL, TO_DATE('2021-08-11 22:54:21', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', TO_DATE('2021-09-27 00:48:54', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员', '超级管理员', NULL, '1', NULL, NULL);
INSERT INTO "BUILDERTABLE" VALUES ('de4a5527-0d8c-4493-b668-39fc9c555df1', 'Resource', NULL, NULL, NULL, 'Resource', 'OpenAuth.Repository.Domain', 'ResourceApp', '资源管理', 'D:/OpenAuth.Pro/Client', NULL, NULL, NULL, TO_DATE('2021-08-29 00:27:29', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', TO_DATE('2021-08-30 00:50:17', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员', '超级管理员', NULL, '1', NULL, NULL);
INSERT INTO "BUILDERTABLE" VALUES ('f07df6d0-eb47-4f00-9167-79d88bcace36', 'wmsinboundorderdtbl', NULL, NULL, NULL, 'wmsinboundorderdtbl', 'OpenAuth.Repository.Domain', 'wmsinboundorderdtbl', '入库订单模块子表', 'D:/OpenAuth.Pro/Client', NULL, NULL, NULL, TO_DATE('2021-08-11 22:54:21', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', TO_DATE('2021-08-23 01:09:27', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员', '超级管理员', 'OrderId', '1', '7f0ca2fd-7fa0-4316-a466-22733d466dd2', NULL);
INSERT INTO "BUILDERTABLE" VALUES ('fc52b31a-fc29-42b6-b53c-99463644fff2', 'dataprivilegerule', NULL, NULL, NULL, 'DataPrivilegeRule', 'OpenAuth.Repository.Domain', 'DataPrivilegeRuleApp', '数据权限', 'D:/OpenAuth.Pro/Client', NULL, NULL, NULL, TO_DATE('2021-09-23 22:35:02', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', TO_DATE('2021-09-26 00:28:20', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员', '超级管理员', NULL, '1', NULL, NULL);
INSERT INTO "BUILDERTABLE" VALUES ('03761b53-e229-4e0e-b7b1-2831bdc84384', 'Stock', '请在自己的电脑测试，服务器是看不出效果的', NULL, NULL, 'Stock', 'OpenAuth.Repository.Domain', 'StockApp', '仓储', 'D:/OpenAuth.Pro/Client', NULL, NULL, NULL, TO_DATE('2020-09-29 00:52:58', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', TO_DATE('2021-08-30 00:32:09', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员', '超级管理员', NULL, '1', NULL, NULL);
INSERT INTO "BUILDERTABLE" VALUES ('1751d517-6d2b-4638-8f5c-aa6355bccb0e', 'Category', NULL, NULL, NULL, 'Category', 'OpenAuth.Repository.Domain', 'CategoryApp', '分类管理', 'D:/OpenAuth.Pro/Client', NULL, NULL, NULL, TO_DATE('2021-09-27 00:26:54', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', TO_DATE('2021-09-27 00:45:56', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员', '超级管理员', NULL, '1', NULL, NULL);
...
-- ----------------------------
DROP TABLE "EXTERNALDATASOURCE";
CREATE TABLE "EXTERNALDATASOURCE" (
  "ID" NVARCHAR2(50) NOT NULL,
  "NAME" NVARCHAR2(50) NOT NULL,
  "DBTYPE" NUMBER(11,0) NOT NULL,
  "CONNECTIONSTRING" NVARCHAR2(500) NOT NULL,
  "SERVER" NVARCHAR2(100),
  "PORT" NUMBER(11,0),
...
DISABLE ROW MOVEMENT
;
COMMENT ON COLUMN "EXTERNALDATASOURCE"."ID" IS '主键';
COMMENT ON COLUMN "EXTERNALDATASOURCE"."NAME" IS '数据源名称';
COMMENT ON COLUMN "EXTERNALDATASOURCE"."DBTYPE" IS '数据库类型';
COMMENT ON COLUMN "EXTERNALDATASOURCE"."CONNECTIONSTRING" IS '连接字符串';
COMMENT ON COLUMN "EXTERNALDATASOURCE"."SERVER" IS '服务器地址';
COMMENT ON COLUMN "EXTERNALDATASOURCE"."PORT" IS '端口';
COMMENT ON COLUMN "EXTERNALDATASOURCE"."DATABASENAME" IS '数据库名称';
COMMENT ON COLUMN "EXTERNALDATASOURCE"."USERNAME" IS '用户名';
COMMENT ON COLUMN "EXTERNALDATASOURCE"."PASSWORD" IS '密码';
COMMENT ON COLUMN "EXTERNALDATASOURCE"."ENABLED" IS '是否启用';
COMMENT ON COLUMN "EXTERNALDATASOURCE"."CREATETIME" IS '创建时间';
COMMENT ON COLUMN "EXTERNALDATASOURCE"."UPDATETIME" IS '最后测试时间';
COMMENT ON COLUMN "EXTERNALDATASOURCE"."TESTSUCCESS" IS '是否测试成功';
COMMENT ON COLUMN "EXTERNALDATASOURCE"."DESCRIPTION" IS '描述';
COMMENT ON COLUMN "EXTERNALDATASOURCE"."CREATEUSERID" IS '创建用户ID';
COMMENT ON COLUMN "EXTERNALDATASOURCE"."CREATEUSERNAME" IS '创建用户名';
COMMENT ON COLUMN "EXTERNALDATASOURCE"."UPDATEUSERID" IS '更新用户ID';
COMMENT ON COLUMN "EXTERNALDATASOURCE"."UPDATEUSERNAME" IS '更新用户名';
COMMENT ON TABLE "EXTERNALDATASOURCE" IS '外部数据源管理';
...
CREATE TABLE "FLOWAPPROVER" (
  ...
  "ORDERNO" NUMBER(11,0),
  "VERIFYDATE" DATE,
  "VERIFYCOMMENT" NVARCHAR2(200),
  "CASCADEID" NVARCHAR2(100) NOT NULL,
  "PARENTID" NVARCHAR2(50),
  "PARENTNAME" NVARCHAR2(100),
  "RETURNTOSIGNNODE" NUMBER(4,0) NOT NULL,
  "NAME" NVARCHAR2(100)
)
LOGGING
NOCOMPRESS
...
-- ----------------------------
INSERT INTO "FLOWINSTANCEOPERATIONHISTORY" VALUES ('09d94511-02cd-412e-bd95-1452c7fe75f1', '6da123db-37d4-4def-a380-f1ec56e814e0', '【创建】超级管理员创建了流程实例【】', TO_DATE('2025-04-11 15:10:31', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员');
INSERT INTO "FLOWINSTANCEOPERATIONHISTORY" VALUES ('109f5f41-8f4e-4b83-b629-38c50ac292a0', 'cbe5dd1a-b820-4c12-be30-f98d9ef70152', '【创建】超级管理员创建了流程实例【】', TO_DATE('2025-04-11 15:10:13', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员');
INSERT INTO "FLOWINSTANCEOPERATIONHISTORY" VALUES ('1ded2706-dd4a-4757-afe4-e8112e0e7f1b', '20b3d94b-c706-46bf-9ca9-2af7b2ee5dbd', '【创建】超级管理员创建了流程实例【】', TO_DATE('2025-04-11 15:17:30', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员');
INSERT INTO "FLOWINSTANCEOPERATIONHISTORY" VALUES ('20776658-82ca-48fe-a9ae-da54b2317763', '3eaf3ffc-fd5f-4ea4-b8d1-ac4ca6226136', '【创建】超级管理员创建了流程实例【】', TO_DATE('2025-04-11 15:12:03', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员');
INSERT INTO "FLOWINSTANCEOPERATIONHISTORY" VALUES ('23d87d42-3004-43f4-ad32-2efb6b58cc1e', '6da123db-37d4-4def-a380-f1ec56e814e0', 'admin-2025-04-11 15:14审批了【管理员】结果：同意，备注：', TO_DATE('2025-04-11 15:15:00', 'SYYYY-MM-DD HH24:MI:SS'), '49df1602-f5f3-4d52-afb7-3802da619558', 'admin');
INSERT INTO "FLOWINSTANCEOPERATIONHISTORY" VALUES ('65ee80b8-6f1e-45a8-9640-468d157f1b2d', 'edd22a7b-e485-4988-b5a6-7955d656aa78', 'admin-2025-04-11 15:15审批了【所有人可以审批】结果：同意，备注：', TO_DATE('2025-04-11 15:15:06', 'SYYYY-MM-DD HH24:MI:SS'), '49df1602-f5f3-4d52-afb7-3802da619558', 'admin');
INSERT INTO "FLOWINSTANCEOPERATIONHISTORY" VALUES ('ab9f7a36-a559-4658-b0c3-bfa065324762', '158b4f11-6534-486a-bf42-cd2c0430157c', '【创建】admin创建了流程实例【admin请假了】', TO_DATE('2025-04-11 15:16:17', 'SYYYY-MM-DD HH24:MI:SS'), '49df1602-f5f3-4d52-afb7-3802da619558', 'admin');
INSERT INTO "FLOWINSTANCEOPERATIONHISTORY" VALUES ('b5dcf121-b9b2-4827-8c61-3f8b205a2220', 'f1098644-b360-4967-8108-fff8f7c2057c', '【创建】admin创建了流程实例【admin发起的审批】', TO_DATE('2025-04-11 15:15:59', 'SYYYY-MM-DD HH24:MI:SS'), '49df1602-f5f3-4d52-afb7-3802da619558', 'admin');
INSERT INTO "FLOWINSTANCEOPERATIONHISTORY" VALUES ('d5d76c13-c802-4ad0-b2b3-077db6560839', 'edd22a7b-e485-4988-b5a6-7955d656aa78', 'admin-2025-04-11 15:15审批了【所有人可以审批】结果：同意，备注：', TO_DATE('2025-04-11 15:15:06', 'SYYYY-MM-DD HH24:MI:SS'), '49df1602-f5f3-4d52-afb7-3802da619558', 'admin');
INSERT INTO "FLOWINSTANCEOPERATIONHISTORY" VALUES ('e9ef6816-3a0f-4f44-9a04-50612b1dca22', '05e8c579-5d59-4f71-bb3f-7688ac834729', '【创建】超级管理员创建了流程实例【】', TO_DATE('2025-04-11 15:12:14', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员');
INSERT INTO "FLOWINSTANCEOPERATIONHISTORY" VALUES ('f1fe9a1b-5926-4394-94f2-08410845ad5d', 'edd22a7b-e485-4988-b5a6-7955d656aa78', '【创建】超级管理员创建了流程实例【】', TO_DATE('2025-04-11 15:10:02', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员');
INSERT INTO "FLOWINSTANCEOPERATIONHISTORY" VALUES ('f6b4ee82-0e78-4947-87e2-d62b91116775', '3eaf3ffc-fd5f-4ea4-b8d1-ac4ca6226136', 'System-2025-04-11 15:14审批了【node_2】结果：同意，备注：', TO_DATE('2025-04-11 15:14:10', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员');
...
CREATE TABLE "FLOWINSTANCETRANSITIONHISTORY" (
  ...
  "FROMNODETYPE" NVARCHAR2(50),
  "FROMNODENAME" NVARCHAR2(200),
  "TONODEID" NVARCHAR2(50),
  "TONODETYPE" NVARCHAR2(50),
...
-- ----------------------------
INSERT INTO "FLOWINSTANCETRANSITIONHISTORY" VALUES ('2c7baa3a-31b6-476e-936c-732ac32ee2ac', 'f1098644-b360-4967-8108-fff8f7c2057c', '1564334327861', '3', 'node_1', '1564334332325', '2', '管理员', '0', '0', TO_DATE('2025-04-11 15:15:59', 'SYYYY-MM-DD HH24:MI:SS'), '49df1602-f5f3-4d52-afb7-3802da619558', 'admin');
INSERT INTO "FLOWINSTANCETRANSITIONHISTORY" VALUES ('3106487d-c8f0-4a12-8304-3146e9a441c8', 'cbe5dd1a-b820-4c12-be30-f98d9ef70152', '1584630842462', '3', 'node_1', '1584630843608', '2', 'node_2', '0', '0', TO_DATE('2025-04-11 15:10:13', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员');
INSERT INTO "FLOWINSTANCETRANSITIONHISTORY" VALUES ('6fad3a96-afb1-4978-8021-a1866a91c496', '3eaf3ffc-fd5f-4ea4-b8d1-ac4ca6226136', '1564334430924', '3', 'node_1', '1564334435460', '2', 'node_2', '0', '0', TO_DATE('2025-04-11 15:12:03', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员');
INSERT INTO "FLOWINSTANCETRANSITIONHISTORY" VALUES ('9f5b0f2c-136f-4014-84be-7077a90d4480', '6da123db-37d4-4def-a380-f1ec56e814e0', '1564334327861', '3', 'node_1', '1564334332325', '2', '管理员', '0', '0', TO_DATE('2025-04-11 15:10:31', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员');
INSERT INTO "FLOWINSTANCETRANSITIONHISTORY" VALUES ('b4e0a526-0432-4c58-baeb-9b5104366c95', '158b4f11-6534-486a-bf42-cd2c0430157c', '1584630766237', '3', 'node_1', '1584630767445', '2', 'node_2', '0', '0', TO_DATE('2025-04-11 15:16:17', 'SYYYY-MM-DD HH24:MI:SS'), '49df1602-f5f3-4d52-afb7-3802da619558', 'admin');
INSERT INTO "FLOWINSTANCETRANSITIONHISTORY" VALUES ('b8a98b6e-4bfa-468c-8507-bcd7787c842e', '20b3d94b-c706-46bf-9ca9-2af7b2ee5dbd', '1584631275414', '3', 'node_1', '1584631276803', '2', 'node_2', '0', '0', TO_DATE('2025-04-11 15:17:30', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员');
INSERT INTO "FLOWINSTANCETRANSITIONHISTORY" VALUES ('cbd29bcb-d034-4800-ac1a-dd44c775aeb2', '05e8c579-5d59-4f71-bb3f-7688ac834729', '1564334138399', '3', 'node_1', '1564334153687', '2', '所有人可以审批', '0', '0', TO_DATE('2025-04-11 15:12:14', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员');
INSERT INTO "FLOWINSTANCETRANSITIONHISTORY" VALUES ('f4c5f77b-32ab-4e95-af60-9ca9c94923f2', 'edd22a7b-e485-4988-b5a6-7955d656aa78', '1564334032785', '3', 'node_1', '1564334035352', '2', '所有人可以审批', '0', '0', TO_DATE('2025-04-11 15:10:02', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员');
...
COMMENT ON COLUMN "RELEVANCE"."RELKEY" IS '映射标识';
...
INSERT INTO "RELEVANCE" VALUES ('59c8b633-167e-47c1-bb63-837780ea93dc', NULL, 'RoleModule', '0', TO_DATE('2020-04-25 11:48:20', 'SYYYY-MM-DD HH24:MI:SS'), NULL, '77e6d0c3-f9e1-4933-92c3-c1c6eef75593', '5c55f7eb-4552-4610-a584-d72685f8d064', NULL, NULL);
...
INSERT INTO "RELEVANCE" VALUES ('7024c6fa-28d2-494f-93af-0651c690e063', NULL, 'RoleModule', '0', TO_DATE('2020-04-25 11:48:20', 'SYYYY-MM-DD HH24:MI:SS'), NULL, 'd27ae3cf-135f-4d57-93a6-2120ddf98650', '5c55f7eb-4552-4610-a584-d72685f8d064', NULL, NULL);
...
INSERT INTO "RELEVANCE" VALUES ('bd82fa18-2500-4e6b-920d-dc235b57f788', NULL, 'RoleModule', '0', TO_DATE('2020-04-25 11:48:20', 'SYYYY-MM-DD HH24:MI:SS'), NULL, '09ee2ffa-7463-4938-ae0b-1cb4e80c7c13', '5c55f7eb-4552-4610-a584-d72685f8d064', NULL, NULL);
...
INSERT INTO "RELEVANCE" VALUES ('abbf150f-907d-450c-836c-6ad3d6885549', NULL, 'RoleModule', '0', TO_DATE('2020-04-25 11:48:20', 'SYYYY-MM-DD HH24:MI:SS'), NULL, '0a7ebd0c-78d6-4fbc-8fbe-6fc25c3a932d', '5c55f7eb-4552-4610-a584-d72685f8d064', NULL, NULL);
...
-- ----------------------------
INSERT INTO "SYSMESSAGE" VALUES ('8f66c6a6-c0f0-48c2-b920-b92ee73fea2a', '系统消息', 'SYS_MSG', '00000000-0000-0000-0000-000000000000', '00000000-0000-0000-0000-000000000000', '系统管理员', 'System', '0', '0', NULL, NULL, '你的流程[所有人都可以审批的流程]已被admin处理。', TO_DATE('2025-04-11 15:15:07', 'SYYYY-MM-DD HH24:MI:SS'), NULL);
INSERT INTO "SYSMESSAGE" VALUES ('ed02094b-6457-4cd2-b6d4-94cef4032794', '系统消息', 'SYS_MSG', '00000000-0000-0000-0000-000000000000', '00000000-0000-0000-0000-000000000000', '系统管理员', 'System', '0', '0', NULL, NULL, '你的流程[会前审批1]已被超级管理员处理。', TO_DATE('2025-04-11 15:14:10', 'SYYYY-MM-DD HH24:MI:SS'), NULL);
INSERT INTO "SYSMESSAGE" VALUES ('62949f07-fc6e-4c81-9403-f4f5da396f14', '系统消息', 'SYS_MSG', '00000000-0000-0000-0000-000000000000', '00000000-0000-0000-0000-000000000000', '系统管理员', 'System', '0', '0', NULL, NULL, '你的流程[所有人都可以审批的流程]已被admin处理。', TO_DATE('2025-04-11 15:15:07', 'SYYYY-MM-DD HH24:MI:SS'), NULL);
INSERT INTO "SYSMESSAGE" VALUES ('78f239e2-af21-4c41-9d9f-948144eccc65', '系统消息', 'SYS_MSG', '00000000-0000-0000-0000-000000000000', '00000000-0000-0000-0000-000000000000', '系统管理员', 'System', '0', '0', NULL, NULL, '你的流程[按角色执行的审批]已被admin处理。', TO_DATE('2025-04-11 15:15:00', 'SYYYY-MM-DD HH24:MI:SS'), NULL);
...
-- ----------------------------
ALTER TABLE "APPLICATION" ADD CONSTRAINT "SYS_C0032365" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table APPLICATION
-- ----------------------------
ALTER TABLE "APPLICATION" ADD CONSTRAINT "SYS_C0032148" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "APPLICATION" ADD CONSTRAINT "SYS_C0032149" CHECK ("NAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "APPLICATION" ADD CONSTRAINT "SYS_C0032150" CHECK ("DISABLE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "APPLICATION" ADD CONSTRAINT "SYS_C0032151" CHECK ("CREATETIME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table BUILDERTABLE
-- ----------------------------
ALTER TABLE "BUILDERTABLE" ADD CONSTRAINT "SYS_C0032367" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table BUILDERTABLE
-- ----------------------------
ALTER TABLE "BUILDERTABLE" ADD CONSTRAINT "SYS_C0032163" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "BUILDERTABLE" ADD CONSTRAINT "SYS_C0032164" CHECK ("TABLENAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "BUILDERTABLE" ADD CONSTRAINT "SYS_C0032165" CHECK ("CLASSNAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "BUILDERTABLE" ADD CONSTRAINT "SYS_C0032166" CHECK ("CREATETIME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table BUILDERTABLECOLUMN
-- ----------------------------
ALTER TABLE "BUILDERTABLECOLUMN" ADD CONSTRAINT "SYS_C0032368" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table BUILDERTABLECOLUMN
-- ----------------------------
ALTER TABLE "BUILDERTABLECOLUMN" ADD CONSTRAINT "SYS_C0032152" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "BUILDERTABLECOLUMN" ADD CONSTRAINT "SYS_C0032153" CHECK ("TABLEID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "BUILDERTABLECOLUMN" ADD CONSTRAINT "SYS_C0032154" CHECK ("ISKEY" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "BUILDERTABLECOLUMN" ADD CONSTRAINT "SYS_C0032155" CHECK ("ISINCREMENT" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "BUILDERTABLECOLUMN" ADD CONSTRAINT "SYS_C0032156" CHECK ("ISREQUIRED" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "BUILDERTABLECOLUMN" ADD CONSTRAINT "SYS_C0032157" CHECK ("ISINSERT" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "BUILDERTABLECOLUMN" ADD CONSTRAINT "SYS_C0032158" CHECK ("ISEDIT" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "BUILDERTABLECOLUMN" ADD CONSTRAINT "SYS_C0032159" CHECK ("ISLIST" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "BUILDERTABLECOLUMN" ADD CONSTRAINT "SYS_C0032160" CHECK ("ISQUERY" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "BUILDERTABLECOLUMN" ADD CONSTRAINT "SYS_C0032161" CHECK ("SORT" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "BUILDERTABLECOLUMN" ADD CONSTRAINT "SYS_C0032162" CHECK ("CREATETIME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table CATEGORY
-- ----------------------------
ALTER TABLE "CATEGORY" ADD CONSTRAINT "SYS_C0032366" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table CATEGORY
-- ----------------------------
ALTER TABLE "CATEGORY" ADD CONSTRAINT "SYS_C0032167" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "CATEGORY" ADD CONSTRAINT "SYS_C0032168" CHECK ("NAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "CATEGORY" ADD CONSTRAINT "SYS_C0032169" CHECK ("DTCODE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "CATEGORY" ADD CONSTRAINT "SYS_C0032170" CHECK ("ENABLE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "CATEGORY" ADD CONSTRAINT "SYS_C0032171" CHECK ("SORTNO" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "CATEGORY" ADD CONSTRAINT "SYS_C0032172" CHECK ("CREATETIME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "CATEGORY" ADD CONSTRAINT "SYS_C0032173" CHECK ("CREATEUSERID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "CATEGORY" ADD CONSTRAINT "SYS_C0032174" CHECK ("CREATEUSERNAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table CATEGORYTYPE
-- ----------------------------
ALTER TABLE "CATEGORYTYPE" ADD CONSTRAINT "SYS_C0032369" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table CATEGORYTYPE
-- ----------------------------
ALTER TABLE "CATEGORYTYPE" ADD CONSTRAINT "SYS_C0032175" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "CATEGORYTYPE" ADD CONSTRAINT "SYS_C0032176" CHECK ("NAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "CATEGORYTYPE" ADD CONSTRAINT "SYS_C0032177" CHECK ("CREATETIME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table DATAPRIVILEGERULE
-- ----------------------------
ALTER TABLE "DATAPRIVILEGERULE" ADD CONSTRAINT "SYS_C0032370" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table DATAPRIVILEGERULE
-- ----------------------------
ALTER TABLE "DATAPRIVILEGERULE" ADD CONSTRAINT "SYS_C0032184" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "DATAPRIVILEGERULE" ADD CONSTRAINT "SYS_C0032185" CHECK ("SOURCECODE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "DATAPRIVILEGERULE" ADD CONSTRAINT "SYS_C0032186" CHECK ("DESCRIPTION" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "DATAPRIVILEGERULE" ADD CONSTRAINT "SYS_C0032187" CHECK ("SORTNO" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "DATAPRIVILEGERULE" ADD CONSTRAINT "SYS_C0032188" CHECK ("PRIVILEGERULES" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "DATAPRIVILEGERULE" ADD CONSTRAINT "SYS_C0032189" CHECK ("ENABLE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "DATAPRIVILEGERULE" ADD CONSTRAINT "SYS_C0032190" CHECK ("CREATETIME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table EXTERNALDATASOURCE
-- ----------------------------
ALTER TABLE "EXTERNALDATASOURCE" ADD CONSTRAINT "SYS_C0032371" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table EXTERNALDATASOURCE
-- ----------------------------
ALTER TABLE "EXTERNALDATASOURCE" ADD CONSTRAINT "SYS_C0032178" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "EXTERNALDATASOURCE" ADD CONSTRAINT "SYS_C0032179" CHECK ("NAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "EXTERNALDATASOURCE" ADD CONSTRAINT "SYS_C0032180" CHECK ("DBTYPE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "EXTERNALDATASOURCE" ADD CONSTRAINT "SYS_C0032181" CHECK ("CONNECTIONSTRING" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "EXTERNALDATASOURCE" ADD CONSTRAINT "SYS_C0032182" CHECK ("ENABLED" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "EXTERNALDATASOURCE" ADD CONSTRAINT "SYS_C0032183" CHECK ("CREATETIME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table FLOWAPPROVER
-- ----------------------------
ALTER TABLE "FLOWAPPROVER" ADD CONSTRAINT "SYS_C0032372" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table FLOWAPPROVER
-- ----------------------------
ALTER TABLE "FLOWAPPROVER" ADD CONSTRAINT "SYS_C0032193" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWAPPROVER" ADD CONSTRAINT "SYS_C0032194" CHECK ("INSTANCEID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWAPPROVER" ADD CONSTRAINT "SYS_C0032195" CHECK ("ACTIVITYID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWAPPROVER" ADD CONSTRAINT "SYS_C0032196" CHECK ("STATUS" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWAPPROVER" ADD CONSTRAINT "SYS_C0032197" CHECK ("APPROVETYPE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWAPPROVER" ADD CONSTRAINT "SYS_C0032198" CHECK ("APPROVERID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWAPPROVER" ADD CONSTRAINT "SYS_C0032199" CHECK ("CASCADEID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWAPPROVER" ADD CONSTRAINT "SYS_C0032200" CHECK ("RETURNTOSIGNNODE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table FLOWINSTANCE
-- ----------------------------
ALTER TABLE "FLOWINSTANCE" ADD CONSTRAINT "SYS_C0032373" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table FLOWINSTANCE
-- ----------------------------
ALTER TABLE "FLOWINSTANCE" ADD CONSTRAINT "SYS_C0032204" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWINSTANCE" ADD CONSTRAINT "SYS_C0032206" CHECK ("FRMTYPE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWINSTANCE" ADD CONSTRAINT "SYS_C0032207" CHECK ("DISABLED" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWINSTANCE" ADD CONSTRAINT "SYS_C0032208" CHECK ("CREATEDATE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWINSTANCE" ADD CONSTRAINT "SYS_C0032209" CHECK ("FLOWLEVEL" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWINSTANCE" ADD CONSTRAINT "SYS_C0032210" CHECK ("ISFINISH" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table FLOWINSTANCEOPERATIONHISTORY
-- ----------------------------
ALTER TABLE "FLOWINSTANCEOPERATIONHISTORY" ADD CONSTRAINT "SYS_C0032374" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table FLOWINSTANCEOPERATIONHISTORY
-- ----------------------------
ALTER TABLE "FLOWINSTANCEOPERATIONHISTORY" ADD CONSTRAINT "SYS_C0032201" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWINSTANCEOPERATIONHISTORY" ADD CONSTRAINT "SYS_C0032202" CHECK ("INSTANCEID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWINSTANCEOPERATIONHISTORY" ADD CONSTRAINT "SYS_C0032203" CHECK ("CREATEDATE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table FLOWINSTANCETRANSITIONHISTORY
-- ----------------------------
ALTER TABLE "FLOWINSTANCETRANSITIONHISTORY" ADD CONSTRAINT "SYS_C0032375" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table FLOWINSTANCETRANSITIONHISTORY
-- ----------------------------
ALTER TABLE "FLOWINSTANCETRANSITIONHISTORY" ADD CONSTRAINT "SYS_C0032211" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWINSTANCETRANSITIONHISTORY" ADD CONSTRAINT "SYS_C0032212" CHECK ("INSTANCEID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWINSTANCETRANSITIONHISTORY" ADD CONSTRAINT "SYS_C0032213" CHECK ("TRANSITIONSATE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWINSTANCETRANSITIONHISTORY" ADD CONSTRAINT "SYS_C0032214" CHECK ("ISFINISH" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWINSTANCETRANSITIONHISTORY" ADD CONSTRAINT "SYS_C0032215" CHECK ("CREATEDATE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table FLOWSCHEME
-- ----------------------------
ALTER TABLE "FLOWSCHEME" ADD CONSTRAINT "SYS_C0032376" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table FLOWSCHEME
-- ----------------------------
ALTER TABLE "FLOWSCHEME" ADD CONSTRAINT "SYS_C0032216" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWSCHEME" ADD CONSTRAINT "SYS_C0032217" CHECK ("FRMTYPE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWSCHEME" ADD CONSTRAINT "SYS_C0032218" CHECK ("AUTHORIZETYPE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWSCHEME" ADD CONSTRAINT "SYS_C0032219" CHECK ("SORTCODE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWSCHEME" ADD CONSTRAINT "SYS_C0032220" CHECK ("DELETEMARK" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWSCHEME" ADD CONSTRAINT "SYS_C0032221" CHECK ("DISABLED" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FLOWSCHEME" ADD CONSTRAINT "SYS_C0032222" CHECK ("CREATEDATE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table FORM
-- ----------------------------
ALTER TABLE "FORM" ADD CONSTRAINT "SYS_C0032377" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table FORM
-- ----------------------------
ALTER TABLE "FORM" ADD CONSTRAINT "SYS_C0032223" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FORM" ADD CONSTRAINT "SYS_C0032224" CHECK ("FRMTYPE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FORM" ADD CONSTRAINT "SYS_C0032225" CHECK ("FIELDS" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FORM" ADD CONSTRAINT "SYS_C0032226" CHECK ("SORTCODE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FORM" ADD CONSTRAINT "SYS_C0032227" CHECK ("DELETEMARK" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FORM" ADD CONSTRAINT "SYS_C0032228" CHECK ("DISABLED" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FORM" ADD CONSTRAINT "SYS_C0032229" CHECK ("CREATEDATE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table FRMLEAVEREQ
-- ----------------------------
ALTER TABLE "FRMLEAVEREQ" ADD CONSTRAINT "SYS_C0032378" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table FRMLEAVEREQ
-- ----------------------------
ALTER TABLE "FRMLEAVEREQ" ADD CONSTRAINT "SYS_C0032230" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FRMLEAVEREQ" ADD CONSTRAINT "SYS_C0032231" CHECK ("USERNAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FRMLEAVEREQ" ADD CONSTRAINT "SYS_C0032232" CHECK ("REQUESTTYPE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FRMLEAVEREQ" ADD CONSTRAINT "SYS_C0032233" CHECK ("STARTDATE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FRMLEAVEREQ" ADD CONSTRAINT "SYS_C0032234" CHECK ("ENDDATE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "FRMLEAVEREQ" ADD CONSTRAINT "SYS_C0032235" CHECK ("CREATEDATE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table MODULE
-- ----------------------------
ALTER TABLE "MODULE" ADD CONSTRAINT "SYS_C0032379" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table MODULE
-- ----------------------------
ALTER TABLE "MODULE" ADD CONSTRAINT "SYS_C0032236" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "MODULE" ADD CONSTRAINT "SYS_C0032237" CHECK ("CASCADEID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "MODULE" ADD CONSTRAINT "SYS_C0032238" CHECK ("NAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "MODULE" ADD CONSTRAINT "SYS_C0032239" CHECK ("URL" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "MODULE" ADD CONSTRAINT "SYS_C0032241" CHECK ("ISLEAF" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "MODULE" ADD CONSTRAINT "SYS_C0032242" CHECK ("ISAUTOEXPAND" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "MODULE" ADD CONSTRAINT "SYS_C0032244" CHECK ("STATUS" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "MODULE" ADD CONSTRAINT "SYS_C0032247" CHECK ("SORTNO" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "MODULE" ADD CONSTRAINT "SYS_C0032248" CHECK ("ISSYS" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table MODULEELEMENT
-- ----------------------------
ALTER TABLE "MODULEELEMENT" ADD CONSTRAINT "SYS_C0032380" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table MODULEELEMENT
-- ----------------------------
ALTER TABLE "MODULEELEMENT" ADD CONSTRAINT "SYS_C0032249" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "MODULEELEMENT" ADD CONSTRAINT "SYS_C0032250" CHECK ("DOMID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "MODULEELEMENT" ADD CONSTRAINT "SYS_C0032251" CHECK ("NAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "MODULEELEMENT" ADD CONSTRAINT "SYS_C0032254" CHECK ("ICON" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "MODULEELEMENT" ADD CONSTRAINT "SYS_C0032255" CHECK ("CLASS" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "MODULEELEMENT" ADD CONSTRAINT "SYS_C0032257" CHECK ("SORT" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "MODULEELEMENT" ADD CONSTRAINT "SYS_C0032258" CHECK ("MODULEID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table OPENJOB
-- ----------------------------
ALTER TABLE "OPENJOB" ADD CONSTRAINT "SYS_C0032381" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table OPENJOB
-- ----------------------------
ALTER TABLE "OPENJOB" ADD CONSTRAINT "SYS_C0032259" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "OPENJOB" ADD CONSTRAINT "SYS_C0032260" CHECK ("JOBNAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "OPENJOB" ADD CONSTRAINT "SYS_C0032261" CHECK ("RUNCOUNT" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "OPENJOB" ADD CONSTRAINT "SYS_C0032262" CHECK ("ERRORCOUNT" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "OPENJOB" ADD CONSTRAINT "SYS_C0032263" CHECK ("JOBTYPE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "OPENJOB" ADD CONSTRAINT "SYS_C0032264" CHECK ("JOBCALL" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "OPENJOB" ADD CONSTRAINT "SYS_C0032265" CHECK ("CRON" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "OPENJOB" ADD CONSTRAINT "SYS_C0032266" CHECK ("STATUS" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "OPENJOB" ADD CONSTRAINT "SYS_C0032267" CHECK ("CREATETIME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "OPENJOB" ADD CONSTRAINT "SYS_C0032268" CHECK ("CREATEUSERID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "OPENJOB" ADD CONSTRAINT "SYS_C0032269" CHECK ("CREATEUSERNAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table ORG
-- ----------------------------
ALTER TABLE "ORG" ADD CONSTRAINT "SYS_C0032382" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table ORG
-- ----------------------------
ALTER TABLE "ORG" ADD CONSTRAINT "SYS_C0032270" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "ORG" ADD CONSTRAINT "SYS_C0032271" CHECK ("CASCADEID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "ORG" ADD CONSTRAINT "SYS_C0032272" CHECK ("NAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "ORG" ADD CONSTRAINT "SYS_C0032275" CHECK ("ISLEAF" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "ORG" ADD CONSTRAINT "SYS_C0032278" CHECK ("STATUS" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "ORG" ADD CONSTRAINT "SYS_C0032281" CHECK ("CREATETIME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "ORG" ADD CONSTRAINT "SYS_C0032282" CHECK ("CREATEID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "ORG" ADD CONSTRAINT "SYS_C0032283" CHECK ("SORTNO" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table RELEVANCE
-- ----------------------------
ALTER TABLE "RELEVANCE" ADD CONSTRAINT "SYS_C0032383" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table RELEVANCE
-- ----------------------------
ALTER TABLE "RELEVANCE" ADD CONSTRAINT "SYS_C0032284" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "RELEVANCE" ADD CONSTRAINT "SYS_C0032286" CHECK ("RELKEY" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "RELEVANCE" ADD CONSTRAINT "SYS_C0032287" CHECK ("STATUS" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "RELEVANCE" ADD CONSTRAINT "SYS_C0032288" CHECK ("OPERATETIME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "RELEVANCE" ADD CONSTRAINT "SYS_C0032289" CHECK ("FIRSTID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "RELEVANCE" ADD CONSTRAINT "SYS_C0032290" CHECK ("SECONDID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table ROLE
-- ----------------------------
ALTER TABLE "ROLE" ADD CONSTRAINT "SYS_C0032384" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table ROLE
-- ----------------------------
ALTER TABLE "ROLE" ADD CONSTRAINT "SYS_C0032291" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "ROLE" ADD CONSTRAINT "SYS_C0032292" CHECK ("NAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "ROLE" ADD CONSTRAINT "SYS_C0032293" CHECK ("STATUS" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "ROLE" ADD CONSTRAINT "SYS_C0032294" CHECK ("CREATETIME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table STOCK
-- ----------------------------
ALTER TABLE "STOCK" ADD CONSTRAINT "SYS_C0032385" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table STOCK
-- ----------------------------
ALTER TABLE "STOCK" ADD CONSTRAINT "SYS_C0032295" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "STOCK" ADD CONSTRAINT "SYS_C0032296" CHECK ("NAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "STOCK" ADD CONSTRAINT "SYS_C0032297" CHECK ("PRODCNT" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "STOCK" ADD CONSTRAINT "SYS_C0032298" CHECK ("PRICE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table SYSLOG
-- ----------------------------
ALTER TABLE "SYSLOG" ADD CONSTRAINT "SYS_C0032386" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table SYSLOG
-- ----------------------------
ALTER TABLE "SYSLOG" ADD CONSTRAINT "SYS_C0032303" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "SYSLOG" ADD CONSTRAINT "SYS_C0032304" CHECK ("CREATETIME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "SYSLOG" ADD CONSTRAINT "SYS_C0032305" CHECK ("CREATEID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "SYSLOG" ADD CONSTRAINT "SYS_C0032306" CHECK ("RESULT" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table SYSMESSAGE
-- ----------------------------
ALTER TABLE "SYSMESSAGE" ADD CONSTRAINT "SYS_C0032387" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table SYSMESSAGE
-- ----------------------------
ALTER TABLE "SYSMESSAGE" ADD CONSTRAINT "SYS_C0032307" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "SYSMESSAGE" ADD CONSTRAINT "SYS_C0032308" CHECK ("TOID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "SYSMESSAGE" ADD CONSTRAINT "SYS_C0032309" CHECK ("FROMSTATUS" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "SYSMESSAGE" ADD CONSTRAINT "SYS_C0032310" CHECK ("TOSTATUS" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "SYSMESSAGE" ADD CONSTRAINT "SYS_C0032311" CHECK ("CREATETIME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table SYSPRINTERPLAN
-- ----------------------------
ALTER TABLE "SYSPRINTERPLAN" ADD CONSTRAINT "SYS_C0032388" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table SYSPRINTERPLAN
-- ----------------------------
ALTER TABLE "SYSPRINTERPLAN" ADD CONSTRAINT "SYS_C0032312" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "SYSPRINTERPLAN" ADD CONSTRAINT "SYS_C0032313" CHECK ("NAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "SYSPRINTERPLAN" ADD CONSTRAINT "SYS_C0032314" CHECK ("DISABLE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "SYSPRINTERPLAN" ADD CONSTRAINT "SYS_C0032315" CHECK ("CREATETIME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table SYSRESOURCE
-- ----------------------------
ALTER TABLE "SYSRESOURCE" ADD CONSTRAINT "SYS_C0032389" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table SYSRESOURCE
-- ----------------------------
ALTER TABLE "SYSRESOURCE" ADD CONSTRAINT "SYS_C0032316" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "SYSRESOURCE" ADD CONSTRAINT "SYS_C0032317" CHECK ("CASCADEID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "SYSRESOURCE" ADD CONSTRAINT "SYS_C0032318" CHECK ("NAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "SYSRESOURCE" ADD CONSTRAINT "SYS_C0032321" CHECK ("DISABLE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "SYSRESOURCE" ADD CONSTRAINT "SYS_C0032322" CHECK ("CREATETIME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table SYSUSER
-- ----------------------------
ALTER TABLE "SYSUSER" ADD CONSTRAINT "SYS_C0032390" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table SYSUSER
-- ----------------------------
ALTER TABLE "SYSUSER" ADD CONSTRAINT "SYS_C0032325" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "SYSUSER" ADD CONSTRAINT "SYS_C0032326" CHECK ("ACCOUNT" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "SYSUSER" ADD CONSTRAINT "SYS_C0032328" CHECK ("NAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "SYSUSER" ADD CONSTRAINT "SYS_C0032330" CHECK ("STATUS" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "SYSUSER" ADD CONSTRAINT "SYS_C0032332" CHECK ("CREATETIME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table UPLOADFILE
-- ----------------------------
ALTER TABLE "UPLOADFILE" ADD CONSTRAINT "SYS_C0032391" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table UPLOADFILE
-- ----------------------------
ALTER TABLE "UPLOADFILE" ADD CONSTRAINT "SYS_C0032333" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "UPLOADFILE" ADD CONSTRAINT "SYS_C0032334" CHECK ("FILENAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "UPLOADFILE" ADD CONSTRAINT "SYS_C0032335" CHECK ("FILEPATH" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "UPLOADFILE" ADD CONSTRAINT "SYS_C0032336" CHECK ("ENABLE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "UPLOADFILE" ADD CONSTRAINT "SYS_C0032337" CHECK ("SORTCODE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "UPLOADFILE" ADD CONSTRAINT "SYS_C0032338" CHECK ("DELETEMARK" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "UPLOADFILE" ADD CONSTRAINT "SYS_C0032339" CHECK ("CREATETIME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table WMSINBOUNDORDERDTBL
-- ----------------------------
ALTER TABLE "WMSINBOUNDORDERDTBL" ADD CONSTRAINT "SYS_C0032392" PRIMARY KEY ("ID", "ORDERID");

-- ----------------------------
-- Checks structure for table WMSINBOUNDORDERDTBL
-- ----------------------------
ALTER TABLE "WMSINBOUNDORDERDTBL" ADD CONSTRAINT "SYS_C0032340" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "WMSINBOUNDORDERDTBL" ADD CONSTRAINT "SYS_C0032341" CHECK ("ORDERID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "WMSINBOUNDORDERDTBL" ADD CONSTRAINT "SYS_C0032342" CHECK ("INSTOCKSTATUS" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "WMSINBOUNDORDERDTBL" ADD CONSTRAINT "SYS_C0032343" CHECK ("ASNSTATUS" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "WMSINBOUNDORDERDTBL" ADD CONSTRAINT "SYS_C0032347" CHECK ("ORDERNUM" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "WMSINBOUNDORDERDTBL" ADD CONSTRAINT "SYS_C0032348" CHECK ("INNUM" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "WMSINBOUNDORDERDTBL" ADD CONSTRAINT "SYS_C0032349" CHECK ("LEAVENUM" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "WMSINBOUNDORDERDTBL" ADD CONSTRAINT "SYS_C0032350" CHECK ("HOLDNUM" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "WMSINBOUNDORDERDTBL" ADD CONSTRAINT "SYS_C0032352" CHECK ("CREATETIME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "WMSINBOUNDORDERDTBL" ADD CONSTRAINT "SYS_C0032353" CHECK ("CREATEUSERID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "WMSINBOUNDORDERDTBL" ADD CONSTRAINT "SYS_C0032354" CHECK ("CREATEUSERNAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table WMSINBOUNDORDERTBL
-- ----------------------------
ALTER TABLE "WMSINBOUNDORDERTBL" ADD CONSTRAINT "SYS_C0032393" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table WMSINBOUNDORDERTBL
-- ----------------------------
ALTER TABLE "WMSINBOUNDORDERTBL" ADD CONSTRAINT "SYS_C0032355" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "WMSINBOUNDORDERTBL" ADD CONSTRAINT "SYS_C0032359" CHECK ("ENABLE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "WMSINBOUNDORDERTBL" ADD CONSTRAINT "SYS_C0032361" CHECK ("RETURNBOXNUM" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "WMSINBOUNDORDERTBL" ADD CONSTRAINT "SYS_C0032362" CHECK ("CREATETIME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "WMSINBOUNDORDERTBL" ADD CONSTRAINT "SYS_C0032363" CHECK ("CREATEUSERID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
