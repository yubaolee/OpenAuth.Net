...
---
* 2025.06.25  📃docs: 增加多语言说明

* 2025.06.24  📃docs: 增加sqlsugar访问多数据库

* 2025.06.14  ⚠️feat: 代码生成器增加排序功能

* 2025.06.14  ⚠️feat: 增加排序字段

* 2025.06.11  🔄refactor: 完善代码生成器

* 2025.06.07  ⚠️feat: 正式删除mvc项目

* 2025.06.06  ⚠️feat: 正式开源vue2客户端

* 2025.05.28  🐛fix: 修复生成单表代码异常

* 2025.05.18  🐛fix: 强化代码生成器

* 2025.05.15  🔄refactor: 删除FlowinstanceTransitionHistory

* 2025.05.14  🔄refactor: 分类调整为sqlsugar

* 2025.05.14  ⚠️feat: 字典分类增加高级查询

* 2025.05.13  ⚠️feat: 打印增加高级查询

* 2025.05.13  ⚠️feat: 数据权限调整为sqlsugar

* 2025.05.13  ⚠️feat: 代码生成器单表支持高级查询和列设置

* 2025.05.11  ⚠️feat: 增加根据表和数据源获取表结构

* 2025.05.11  🔄refactor: 优化提交字段校验

* 2025.05.11  ⚠️feat: 优化代码生成

* 2025.05.10  ⚠️feat: 强化代码生成器

* 2025.05.10  ⚠️feat: 强化多表代码生成

* 2025.05.08  🔧chore: 增加入库订单单元测试

* 2025.05.08  🐛fix: 修复入库订单更新异常

* 2025.05.08  🔧chore: 增加cursor codebase indexing忽略配置

* 2025.05.07  ⚠️feat: 入库订单调整为sqlsugar，并支持自定义查询

* 2025.05.06  ⚠️feat: 增加高级查询

* 2025.04.29  ⚠️feat: 增加低代码平台脚本

* 2025.04.29  🔧chore: 增加cursor mcp Servers支持

* 2025.04.21  🐛fix: 紧急修复待办列表数据异常

* 2025.04.19  🐛fix: #IC2GBH 流程审批页面显示不出数据

* 2025.04.19  🐛fix: 修复顺序审批时，节点审批人为全部加签的异常

* 2025.04.18  🐛fix: 修复会签节点审批

* 2025.04.17  ⚠️feat: 分离会签和网关功能

* 2025.04.17  🔄refactor: 修改approvetype类型

* 2025.04.17  🔄refactor: 调整历史记录的fromnodetype/tonodetype

* 2025.04.17  🔄refactor: 流程模板end round 切换为end，统一判断流程结束

* 2025.04.17  🔄refactor: 去掉流程实例的ActivityType，重构节点类型相关代码

* 2025.04.17  🔄refactor: 优化代码结构

* 2025.04.14  🐛fix: 修复点击选中行

* 2025.04.13  🔄refactor: 删除treetable css

* 2025.04.12  ⚠️feat: 优化layui样式

* 2025.04.11  ⚠️feat: 审批节点可以配置SQL指定审批人

* 2025.04.11  🔄refactor: 优化流程审批节点权限

* 2025.04.11  🐛fix: 优化审批节点逻辑

* 2025.04.11  🔄refactor: Relevance替换key为relkey

* 2025.04.11  🐛fix: #I62Y74 执行权限扩展成支持Sql

* 2025.04.10  ⚠️feat: 节点执行权限增加指定sql

* 2025.04.09  📃docs: 删除.net 4.0的文档

* 2025.04.09  📃docs: 增加url表单操作说明

* 2025.04.08  📃docs: 分离vue2和vue3版本

* 2025.04.07  ⚠️feat: 流程审批通知时，可以使用相对路径

* 2025.04.06  📃docs: 更新表单说明

* 2025.04.06  📃docs: 业务发起送审

* 2025.04.06  🔄refactor: 流程模板调整为sqlsugar

* 2025.04.06  ⚠️feat: #IBYEGX 业务系统增加送审功能

* 2025.04.04  ⚠️feat: #IBYEGX 增加URL表单
